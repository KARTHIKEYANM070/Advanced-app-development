...
// import com.job_portal.online_job_portal.model.SearchParams;
...
// @PostMapping("/search")
//     public List<Job> searchJobs(@RequestBody SearchParams searchParams) {
//         return r.searchJobs(searchParams);
//     }
